    ...
    ms.classes.Widget = function (el, settings, inherit) {
        ...
        */
        that.init = function (ss) {
            ...
            that.buttons.set = {text: (that.live) ? s.closeText : s.cancelText, css: 'dwb-c', handler: that.cancel};
            that.buttons.cancel = { text: s.setText, css: 'dwb-s', handler: that.select   };
...
(function ($, undefined) {
    ...
    $.mobiscroll.presets.scroller.select = function (inst) {
        ...
        input = $('<input type="text" id="' + id + '" class="' + s.inputClass + 'frm_input'+ '" placeholder="' + (s.placeholder || '') + '" readonly />');
